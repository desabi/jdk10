 ...
 * These methods are useful when you want to create immutable collections directly from streams,
 * ensuring that any attempt to modify them will result in an UnsupportedOperationException.
 */
