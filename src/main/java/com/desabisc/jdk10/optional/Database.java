...
/**
 * Fetching Data from a Database Consider a situation where you're retrieving data from a database
 * using a repository method. The repository might return an Optional to indicate that the result
 * could be empty if no matching data is found.
 */
