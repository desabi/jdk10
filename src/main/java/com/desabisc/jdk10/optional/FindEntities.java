...
/**
 * Finding Entities in Collections. You might have a collection of entities (like a list of products)
 * and want to find a specific entity based on some criteria. If the entity isn't found, you throw
 * an exception.
 */
